...
const globeConfig = {
  ...
  shininess: 0.9,
  polygonColor: "rgba(192, 132, 252, 0.55)",
  ambientLight: "#8b5cf6",
  directionalLeftLight: "#e9d5ff",
  directionalTopLight: "#f5f3ff",
  pointLight: "#c084fc",
  arcTime: 1000,
  arcLength: 0.9,
  rings: 1,
...
const sampleArcs = [
  ...
  { order: 2, startLat: -15.785493, startLng: -47.909029, endLat: 36.162809, endLng: -115.119411, arcAlt: 0.3, color: colors[Math.floor(Math.random() * colors.length)] },
  ...
  { order: 4, startLat: 51.5072, startLng: -0.1276, endLat: 48.8566, endLng: -2.3522, arcAlt: 0.1, color: colors[Math.floor(Math.random() * colors.length)] },
  ...
  { order: 6, startLat: 22.3193, startLng: 114.1694, endLat: 51.5072, endLng: -0.1276, arcAlt: 0.3, color: colors[Math.floor(Math.random() * colors.length)] },
  ...
  { order: 7, startLat: 52.52, startLng: 13.405, endLat: 34.0522, endLng: -118.2437, arcAlt: 0.2, color: colors[Math.floor(Math.random() * colors.length)] },
